...
export interface SettingsActionsValue {
  ...
  setControlsRebindActionId: React.Dispatch<React.SetStateAction<string | null>>;
}
...
const DeleteConfirmStateContext =
  createContext<DeleteConfirmStateValue | null>(null);
        ...
        <BranchPickerStateContext.Provider value={branchPickerState}>
          <BranchPickerActionsContext.Provider value={branchPickerActions}>
            <DeleteConfirmStateContext.Provider value={deleteConfirmState}>
              <DeleteConfirmActionsContext.Provider value={deleteConfirmActions}>
                {children}
